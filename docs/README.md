# School Parent Enquiry AI — Documentation Index

> Documentation architecture v2 (School Growth System era). Engineering constitution:
...
| [PRODUCT_ROADMAP.md](02-product/PRODUCT_ROADMAP.md) | V1 Parent Enquiry System → V2 Growth System → V3 Voice → V4 Platform (+ preserved V1 phase plan) |
| [USER_JOURNEY.md](02-product/USER_JOURNEY.md) | Parent & school journeys |
...
| [PATIENT_EXPERIENCE.md](03-engineering/PATIENT_EXPERIENCE.md) | Parent Experience Layer (filename preserved as a stable doc anchor referenced by code comments): main menu, decision matrix, component library, resume strategy, rich media, branding, Meta limits |
...
| [KNOWLEDGE_STRUCTURE.md](03-engineering/KNOWLEDGE_STRUCTURE.md) | Per-school knowledge model (no-code onboarding) |
...
| [08-deployment/DEPLOYMENT.md](08-deployment/DEPLOYMENT.md) | Topology, env matrix, school onboarding runbook |
| [09-changelog/CHANGELOG.md](09-changelog/CHANGELOG.md) | Doc/prompt/contract/schema change history |

### Shared data files
- [FAQ_SCHEMA.json](FAQ_SCHEMA.json) — per-school FAQ JSON schema (unchanged location).
...
2. Docs update in the same PR as the change that invalidates them.
